(function(e) {
                    ...
                    flip: {
                        ...
                        top: function(e, t) {
                            var i, s, a = t.within,
                                ...
                                m = -2 * t.offset[1];
                            0 > u ? (s = e.top + p + f + m + t.collisionHeight - o - n, (0 > s || r(u) > s) && (e.top += p + f + m)) : d > 0 && (i = e.top - t.collisionPosition.marginTop + p + f + m - h, (i > 0 || d > r(i)) && (e.top += p + f + m))
                        }
                    },
                    flipfit: {
                        left: function() {
    ...
    var n, o = "ui-button ui-widget ui-state-default ui-corner-all",
    ...
    e.widget("ui.button", {
        ...
        _create: function() {
            ...
            null === i.label && (i.label = "input" === this.type ? this.buttonElement.val() : this.buttonElement.html()), this._hoverable(this.buttonElement), this.buttonElement.addClass(o).attr("role", "button").bind("mouseenter" + this.eventNamespace, function() {
                i.disabled || this === n && e(this).addClass("ui-state-active")
                ...
                return i.disabled ? !1 : (e(this).addClass("ui-state-active"), n = this, t.document.one("mouseup", function() {
                    n = null
                }), void 0)
